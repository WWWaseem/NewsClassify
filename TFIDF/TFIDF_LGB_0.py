...
X_train, X_eval, y_train, y_eval = train_test_split(train_term_doc, train_df['label'], test_size=0.2, shuffle=True, random_state=2021)  # split the training data
...
test_df['label'].to_csv("TFIDF_LGB_0.csv", index=False, header=True, encoding='utf-8')
